            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/login">Iniciar sesion.</a>
                        <a class="collapse-item" href="/register">Registrar</a>
                        <a class="collapse-item" href="/forgot-password">Olvidaste tu contraseña</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="/401">Pagina 401</a>
                        <a class="collapse-item" href="/404">Pagina 404</a>
                        <a class="collapse-item" href="/500">Pagina 500</a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    ...
                                    <p>El acceso no esta autorizado.</p>
                                    <a href="/">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Tu Website 2023</div>
                            <div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Tu Website 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->  
